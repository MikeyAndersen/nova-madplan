/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6448d31bd3a67face3d356eb6427c06)
// Runtime types generated with workerd@1.20260701.1 2026-06-17 global_fetch_strictly_public
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	ASSETS: Fetcher;
	MADPLAN_API_BASE: string;
	LIFEHUB_API_TOKEN: string;
}
